        ...
        if (!req.query.depth) {
          ...
          entities.forEach(function (item) {
            ...
            if (!!item.operatedBy && item.operatedBy.type == 'federation')
              item.operatedBy = config.baseURL + settings.federation + '/' + item.operatedBy.id;
            else if (!!item.operatedBy && item.operatedBy.type == 'participant')
              item.operatedBy = config.baseURL + settings.participant + '/' + item.operatedBy.id;
          });
    ...
    entityModel.findById(req.params.id).select('-_id -__v -updatedAt -createdAt')
      ...
      .then(function (entity) {
        ...
        if (!!entity.operatedBy && entity.operatedBy.type == 'federation')
          entity.operatedBy = config.baseURL + settings.federation + '/' + entity.operatedBy.id;
        else if (!!entity.operatedBy && entity.operatedBy.type == 'participant')
          entity.operatedBy = config.baseURL + settings.participant + '/' + entity.operatedBy.id;
